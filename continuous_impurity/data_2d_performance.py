...
X,y = datasets.make_moons()#datasets.load_iris(return_X_y = True)
FEATURES = [0,1]
X = X[:,FEATURES]
...
MYMODEL_HYPERPARAMS = {"iters": 1000, \
    "learn_rate": 10, \
    "min_depth": 1, \
    "max_depth": 8, \
...
NUM_TRAIN_STOPS = 10
DECISION_BOUND_GRAPH_STEP = 0.0025
...
for train_stop in range(NUM_TRAIN_STOPS):
    try:
        ...
        print("Training halted. Completed train stop: ", train_stop)
